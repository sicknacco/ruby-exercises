RSpec.describe 'Nested Collections' do
  ...
  it 'test 3' do
    ...
    coordinates = [[2,5],[87,2],[56,39],[6,55]]
  ...
  it 'test 4' do
    ...
    # to 0
    coordinates = [[2,5],[87,2],[56,39],[3,0]]
  ...
  it 'test 5' do
    ...
    coordinates = [[2,5],[87,2],[56,39],[3,46],[4, 14]]
  ...
  it 'test 15' do
    ...
    actual = three_day_forecast [:high]=55
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  it 'test 18' do
    ...
    actual = three_day_forecast.value("6-21-18")
    expected = "date"
    expect(actual).to eq(expected)
  end
